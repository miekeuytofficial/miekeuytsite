...
<template>
  <div class="experience-window" @click="handleShowBody">
    <div class="experience-header" :class="{ 'hidden-body': !showBody }">
      <div class="header-group-wrapper">
        ...
        <div class="skills-grid">
          ...
          >
            <div
              class="img-inner"
              :style="{ 'background-image': `url(skills-img/${skill.img}.png)` }"
      ...
      <div class="arrow">
        <font-awesome-icon
          :icon="`fa-icon ${showBody ? 'fa-chevron-up' : 'fa-chevron-down'}`"
          size="xs"
        />
      </div>
    </div>
    <div v-if="showBody" class="experience-body">
      <div
        class="experience-body--inner"
        :class="{ 'experience-body--inner--no-skills': skills.length === 0 }"
      >
        ...
        <div class="description-wrapper">
          ...
          <ul>
            <li v-for="(desc, descIdx) in description" :key="descIdx">
              {{ descHasSublist(desc) ? desc[0] : desc }}
