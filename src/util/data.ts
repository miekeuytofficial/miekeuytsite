export const testimonials = [
  {
    quoterInfo: {
      ...
      company: 'Pathzero',
      role: 'Co-Founder & CTO',
      profileUrl: `https://www.linkedin.com/in/charbelayoub/`
    },
    imgUrl:
...
It was inspiring to watch her journey as she transitioned into a software engineer role. She is dependable, mature, and would be a great addition to any team. During her time with us, Monique made significant contributions to both internal tooling and critical client-facing projects, showcasing her exceptional problem-solving skills and dedication to excellence.`
  },
  {
    quoterInfo: {
      ...
      profileUrl: 'https://www.linkedin.com/in/ian-glass-01979b7b/'
    },
    imgUrl:
      'https://media.licdn.com/dms/image/C5603AQFPnWWTLyHeEA/profile-displayphoto-shrink_100_100/0/1624573234892?e=1695859200&v=beta&t=YpF-zvHmRurREHC23dzu81TgF2HuKj2PFnOKlhNLwGQ',
    quote: `Monique is an absolute pleasure to work with, bringing a positive attitude everyday.
...
I couldn't recommend her enough and I'm excited to see how she further grows and applies herself in the future!`
  },
  {
    ...
    quote: `Monique is an exceptional engineer, with the rare ability to combine excellence in software development with a holistic product focus. She has consistently delivered significant value across the entire SDLC process, all the way through discovery, design, development, testing, and maintenance.
...
Monique's dedication, collaboration, enthusiasm, and team spirit made it a privilege to work with her and I can't recommend highly enough`
  },
  {
    quoterInfo: {
      ...
      company: 'Pathzero',
      role: 'Co-Founder & CEO',
      profileUrl: `https://www.linkedin.com/in/carlprins/`
    },
...
In summary, I highly recommend Monique to any team looking for a talented and adaptable software developer who brings positivity and energy to every project. It was a privilege to work with her, and I have no doubt she will continue to excel in all her future endeavors.`
  ...
  {
    imgUrl:
      'hhttps://media.licdn.com/dms/image/C5603AQFM6R4-mdaFDQ/profile-displayphoto-shrink_400_400/0/1668076652434?e=1697068800&v=beta&t=cFA3VKSNRpIiXCNz20AySNIIhV3DI998u1MMNUiLD5E',
    quoterInfo: {
      name: 'Carrie Markel',
      company: 'Pathzero',
      role: 'Senior Product Designer',
      profileUrl: 'https://www.linkedin.com/in/carriemarkel/'
    },
    quote: `I worked with Monique on building out design system tokens and components to support product design features at Pathzero. In my work as a designer, the tiniest changes in padding, text, and color can throw off a component's visual quality, so having a developer like Monique who shared the same passion for pursuing excellence in UI not just functionality was a dream. On top of that finesse, she's great at asking nuanced questions, finding edge cases and working collaboratively towards solutions. Anyone would be lucky to have her on a team.`
  },
  {
    imgUrl:
      'https://media.licdn.com/dms/image/C5603AQFqzCu7A--Xhg/profile-displayphoto-shrink_400_400/0/1633334559906?e=1697068800&v=beta&t=EvbLeVBORBqJD7nR8KNDjbgfIn2psf8SzpL9ABkRslU',
    quoterInfo: {
      name: 'Kirsten Hendriks',
      company: 'Pathzero',
      role: 'Senior Software Engineer',
      profileUrl: 'https://www.linkedin.com/in/kirstenemhendriks/'
    },
    quote: `Monique worked in a team parallel to mine and I feel I missed out by not having an opportunity to work with her more closely.
I was always impressed by her willingness to jump on a variety of different projects, capacity to handle change, and her ability to succinctly express her opinion.
I experienced her positive impact on team spirit even working alongside rather than directly with her. She made many broader team meetings more engaging, both through participation and taking initiative to lead them.
I'm looking forward to seeing the path her energy and enthusiasm take her on!`
  }
]
